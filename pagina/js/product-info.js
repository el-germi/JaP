...
document.addEventListener("DOMContentLoaded", () => {
  ...
  getJSONData(URLComentarios)
    ...
    .then(() => {
      ...
      comentarios = comentarios.concat(
        comentariosGuardados.filter((e) => e.product == prodID)
      );
      mostrarComentarios();
    });
  ...
  boton.addEventListener("click", () => {
    ...
    Swal.fire("Enviado!", "Nuevo comentario guardado con exito", "success");
